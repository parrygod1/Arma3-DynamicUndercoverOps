...
hostileCivsEnabled = if (random 1 > 0.5 && (profileNamespace getVariable ["DRO_hostileCivsEnabled", 1]) == 1) then {true} else {false};
...
missionNamespace setVariable ["playersSide", playersSide, true];
...
missionNamespace setVariable ["enemySide", enemySide, true];
missionNamespace setVariable ["enemyFaction", enemyFaction, true];
